...
if ($trx_addons_show_image) {
	$trx_addons_post_thumb = get_the_post_thumbnail($trx_addons_post_id, trx_addons_get_thumb_size('recent'), array(
		'alt' => get_the_title()
	));
...
$trx_addons_output .= '<div class="post_content">'
			...
			. '<div class="post_info">'
				. ($trx_addons_show_date 
					? '<span class="post_info_item post_info_posted  icon-calendar-light">'
