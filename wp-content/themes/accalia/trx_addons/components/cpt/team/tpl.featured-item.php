...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
											...
											'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('team'), 'team-featured'),
											'post_info' => !empty($meta['socials']) 
														? '<div class="trx_addons_hover_content">'
															. '<h4 class="sc_team_item_title trx_addons_hover_title"><a href="' . esc_url($link) . '">' . wp_kses_post( get_the_title() ) . '</a></h4>'
