		...
		?><div class="11 post_meta"><?php
			...
			foreach ($components as $comp) {
				...
				// Post date
					...
					if (!empty($dt)) {
						?>
						<span class="icon-calendar-light post_meta_item post_date<?php if (!empty($args['seo'])) echo ' date updated'; ?>"<?php if (!empty($args['seo'])) echo ' itemprop="datePublished"'; ?>><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html($dt); ?></a></span>
						<?php
					}
