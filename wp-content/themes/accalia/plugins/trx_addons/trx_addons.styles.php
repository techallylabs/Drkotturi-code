...
if (!function_exists('accalia_trx_addons_get_css')) {
	add_filter('accalia_filter_get_css', 'accalia_trx_addons_get_css', 10, 4);
	function accalia_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
header.scheme_alternative .socials_wrap .social_item .social_icon{
    background-color: {$colors['text_link']};
//    color: {$colors['text_link3']};
}
