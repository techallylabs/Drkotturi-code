<?php
/**
 * ThemeREX Addons Custom post type: Cars (Taxonomy 'Maker' support)
 *
 * @package WordPress
...
if (!function_exists('trx_addons_cpt_cars_taxonomy_maker_init')) {
	...
	function trx_addons_cpt_cars_taxonomy_maker_init() {
		...
		register_taxonomy( TRX_ADDONS_CPT_CARS_TAXONOMY_MAKER, TRX_ADDONS_CPT_CARS_PT, array(
			...
			'hierarchical'      => true,
			'labels'            => array(
				'name'              => esc_html__( 'Maker', 'trx_addons' ),
				'singular_name'     => esc_html__( 'Maker', 'trx_addons' ),
				'search_items'      => esc_html__( 'Search Maker', 'trx_addons' ),
				'all_items'         => esc_html__( 'All Makers', 'trx_addons' ),
				'parent_item'       => esc_html__( 'Parent Maker', 'trx_addons' ),
				'parent_item_colon' => esc_html__( 'Parent Maker:', 'trx_addons' ),
				'edit_item'         => esc_html__( 'Edit Maker', 'trx_addons' ),
				'update_item'       => esc_html__( 'Update Maker', 'trx_addons' ),
				'add_new_item'      => esc_html__( 'Add New Maker', 'trx_addons' ),
				'new_item_name'     => esc_html__( 'New Maker Name', 'trx_addons' ),
				'menu_name'         => esc_html__( 'Makers', 'trx_addons' ),
			),
			'show_ui'           => true,
