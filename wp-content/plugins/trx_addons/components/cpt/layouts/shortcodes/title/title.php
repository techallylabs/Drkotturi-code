	...
	function trx_addons_sc_layouts_title_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Layouts_Title extends TRX_Addons_Elementor_Layouts_Widget {
			...
			protected function _content_template() {
				trx_addons_get_template_part(TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . "title/tpl.title.php",
										'trx_addons_args_sc_layouts_title',
										array('element' => $this)
									);
			}
...
if (!function_exists('trx_addons_sc_layouts_title_black_list')) {
	add_action( 'elementor/widgets/black_list', 'trx_addons_sc_layouts_title_black_list' );
	function trx_addons_sc_layouts_title_black_list($list) {
