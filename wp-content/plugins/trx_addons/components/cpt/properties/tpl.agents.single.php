...
while ( have_posts() ) { the_post();
	...
	?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'agents_page itemscope' ); ?>
		...
		if ($page_number==1 && trim(get_the_content()) != '') {
			?><section class="properties_page_section properties_page_content entry-content" itemprop="articleBody"><?php
