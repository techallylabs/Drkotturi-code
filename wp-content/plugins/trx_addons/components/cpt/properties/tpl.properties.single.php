...
while ( have_posts() ) { the_post();
	...
	?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'properties_page itemscope' ); ?>
		...
		// Post content
		?><section id="<?php echo esc_attr($trx_addons_tabs_id.'_description'); ?>_content" class="properties_page_section properties_page_content entry-content" itemprop="articleBody"><?php
			if (trx_addons_get_option('properties_single_style') == 'tabs') {
