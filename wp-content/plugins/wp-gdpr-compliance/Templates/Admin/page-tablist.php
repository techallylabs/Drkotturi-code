...
<aside class="wpgdprc-sidebar">
    <nav class="wpgdprc-sidebar__nav" aria-labelledby="sidebar-nav">
        <h2 id="sidebar-nav" class="screen-reader-text"><?php echo $title; ?></h2>
        <ul class="wpgdprc-sidebar__list">
            <?php foreach( $tabs as $slug => $data ) :
                ...
                <li class="wpgdprc-sidebar__item">
                    <a href="<?php echo $data['url']; ?>" class="wpgdprc-sidebar__anchor <?php echo esc_attr($class); ?>" title="<?php echo esc_attr($title); ?>">
