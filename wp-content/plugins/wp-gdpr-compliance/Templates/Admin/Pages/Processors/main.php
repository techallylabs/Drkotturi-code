...
if( isset($_GET['new']) || isset($_GET['edit']) ) {
    ...
    Template::render('Admin/Pages/Processors/Edit/main', [
        'current' => $prefix,
        'id'      => $id,
...
<form method="post" action="<?php echo PageDashboard::getFormAction($current); ?>">
	...
	<div class="wpgdprc-content__container">
		<section class="wpgdprc-tabs wpgdprc-tabs--consents" data-tabs>
			<div class="wpgdprc-tabs__header">
				<div class="wpgdprc-tabs__title-container">
					<h3 class="wpgdprc-tabs__title h3"><?php _ex('Data processors', 'admin', 'wp-gdpr-compliance'); ?></h3>
                    <?php Elements::link(
                        add_query_arg([ 'new' => '' ], PageDashboard::getTabUrl(PageDashboard::TAB_PROCESSORS)),
                        _x('Add data processor', 'admin', 'wp-gdpr-compliance'),
                        [ 'class' => 'wpgdprc-button wpgdprc-button--white wpgdprc-button--small wpgdprc-button--border', 'role' => 'button' ]
                    ); ?>
				</div>
                    ...
                    <?php foreach( $tabs as $type => $data ) : ?>
						<li class="wpgdprc-tabs__item" role="presentation">
							<button class="wpgdprc-button wpgdprc-button--transparent wpgdprc-button--small wpgdprc-tabs__anchor"
									...
									id="tab-<?php echo $type; ?>-processors"
									role="tab"
									aria-controls="<?php echo $type; ?>-processors"
									aria-selected="<?php echo $data['selected']; ?>" tabindex="0">
			...
			<div class="wpgdprc-tabs__container">
                <?php foreach( $tabs as $type => $data ) : ?>
					<div class="wpgdprc-tabs__block wpgdprc-tabs__block--<?php echo $type; ?>" id="<?php echo $type; ?>-processors" role="tabpanel" aria-labelledby="tab-<?php echo $type; ?>-processors" aria-hidden="<?php echo $data['hidden']; ?>">
                        <?php foreach( $data['list'] as $id => $object ) {
                            Template::render('Admin/Pages/Processors/item', [
                                'object' => $object,
                            ]);
                        } ?>
					</div>
		...
		<?php Template::render('Admin/Pages/Processors/footer', [
			'current' => $current,
		]); ?>
