...
if( !Settings::isPremium() ) {
    $list['premium'] = [
        ...
        'link'   => [
            ...
            'attributes' => ['target' => '_blank', 'class' => 'wpgdprc-sign-up-button'],
        ],
...
<header class="wpgdprc-content__header">
	<h2 class="wpgdprc-content__title"><?php _ex('Dashboard', 'admin', 'wp-gdpr-compliance'); ?></h2>
</header>

<?php if( $welcome ) Template::render('Admin/Pages/Dashboard/welcome', []); ?>
