...
<?php submit_button(_x('Activate', 'admin', 'wp-gdpr-compliance'), $enable_class, PageSettings::SECTION_INTEGRATE.'[enable]['.$type.']', false, ['data-enable' => '1', 'data-type' => $type]); ?>
<button class="<?php echo $manage_class; ?>" data-action="manage" aria-expanded="false" aria-controls="<?php echo $controls; ?>">
