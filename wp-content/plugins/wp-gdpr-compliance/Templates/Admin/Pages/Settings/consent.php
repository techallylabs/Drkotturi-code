...
<h3 class="screen-reader-text">
    <?php _ex('Consent bar', 'admin', 'wp-gdpr-compliance'); ?>
</h3>
	...
	<div class="grid-x grid-margin-x grid-margin-y">
		<div class="cell large-12">
			<div class="wpgdprc-form__intro">
				...
				<p class="wpgdprc-form__text <?php if( !$premium ) echo 'hidden'; ?>">
                    <?php printf(_x('Style your Consent Bar and Consent Pop-up at %1s.', 'admin', 'wp-gdpr-compliance'), _x('your Cookie Information account', 'admin', 'wp-gdpr-compliance')); ?>
				</p>
			</div>
		</div>
