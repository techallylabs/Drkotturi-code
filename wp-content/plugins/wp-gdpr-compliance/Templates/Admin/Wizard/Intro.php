...
<p><?php _ex('We will significantly extend the features of this plugin to protect our community against the increasing pressure from Data Protection Agencies, giving hefty fines for non-compliant cookie consents. To enable business users to comply with GDPR, we will offer a business solution that easily allows you to become compliant and avoid fines.', 'admin', 'wp-gdpr-compliance') ?></p>
<br>
<p><?php _ex('If you run a business within the EU, we strongly recommend changing to the business version to secure 100% compliance. Features include customizable consent pop-ups, automated cookie policies, integration to Google Products, and much more.', 'admin', 'wp-gdpr-compliance') ?></p>
<br>
...
<br>
<p><?php _ex('It appears you have not yet completed the first time setup.', 'admin', 'wp-gdpr-compliance') ?></p>
