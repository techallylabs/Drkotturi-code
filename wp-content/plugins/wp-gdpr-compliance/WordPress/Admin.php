...
class Admin {
    ...
    public static function activationNotice() {
        ...
        echo AdminHelper::wrapNotice(sprintf(_x('<strong>Awesome!</strong> You have activated the %1s plugin.', 'admin', 'wp-gdpr-compliance'), Config::pluginName()) . '<br/>' . sprintf(_x('To update the settings and read about what this plugin can do, go to our %1s page.', 'admin', 'wp-gdpr-compliance'), $link));
    }
